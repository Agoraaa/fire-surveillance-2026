...
class ProblemModel:
    ...
    def from_excel(excelPath):
        ...
        for index, row in node_df.iterrows():
            ...
            row['forest_rate'], row['fire_spread_rate'], row['is_village'], row['slope'], row['ymn'])
            nodes.append(node)
...
class Node:
    def __init__(self, id, x_coord, y_coord, height, risk_status, is_buildable, vision_bonus, forest_rate, fire_spread_rate, is_village, slope, ymn):
        self.id = id-1
